...
\textbf{\subsubsection{Unevaluated Expressions}}
...
The lexical changes made the pattern functions simpler lexically.  The functional changes with the use of the complement operator \texttt{\~}, it was possible to reduce the size of the pattern function set.  Clarity was improved with a lexically consistent pattern concatenation operator, lexically consistent lexemes for the pattern assignment operators and more concise lexemes for the pattern functions.
